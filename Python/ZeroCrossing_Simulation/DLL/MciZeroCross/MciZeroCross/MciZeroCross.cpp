...
static sint32 MciZeroCross__GetInputSignal(void);
...
*  @return		BOOL_TYPE
*/
void MciZeroCross__Initialize(sint32 val_param)
{
	sint32 i;
	Y_Out = 0;
	...
	Negative_Threshold_Lobe = FILTER_COEFF_TO_IQ(-0.57);
	Positive_Threshold_Lobe = FILTER_COEFF_TO_IQ(0.61);

	ZC_Val_Param = val_param;
}
...
sint32 MCiZeroCross__ButterworthFilter(void)
{
	...
	Filter_Data_Input[0] = MciZeroCross__GetInputSignal();
...
*  @return     
*/
sint32 MciZeroCross__GetInputSignal(void)
{
