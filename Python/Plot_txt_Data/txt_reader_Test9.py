...
# Mci_Error_Holder = np.zeros(len(content))
# SR_Motor_Fault_Holder = np.zeros(len(content))
...
for i in range(0,len(content)):
    ...
    # Mci_Error_Holder[i] = list_of_numbers[7]
    # SR_Motor_Fault_Holder[i] = list_of_numbers[8]
...
# plt.figure(5)
# plt.plot(time, Mci_Error_Holder, linewidth=1, label ='Mci Error Holder', color ='red')
# plt.plot(time, SR_Motor_Fault_Holder, linewidth=1, label ='Motor Fault Holder', color ='blue')
# plt.legend(loc='upper right', fontsize = 'small')
# plt.grid
# plt.show()
